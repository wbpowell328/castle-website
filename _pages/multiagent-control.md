---
layout: page
title: "Multiagent Control"
permalink: /multiagent-control/
...
<em><a href="http://castle.princeton.edu/Papers/Berger%20Boukhtouta%20George%20Powell-Adaptive%20learning%20framework%20for%20semi-cooperative%20multi-agent%20coordinat.pdf" target="_blank" rel="noopener">(click here to download paper)</a></em>

<strong>Topaloglu, H. and W.B. Powell, “A Distributed Decision-Making Structure for Dynamic Resource Allocation with Nonlinear Functional Approximations,” Operations Research, Vol. 53, No. 2, pp. 281-297 (2005) (c) Informs</strong>

<em>Many complex problems in transportation are characterized by multiple decision-makers who control their own decisions with their own information. Coordinating these decision makers is a well-recognized challenge. This paper proposes to use a </em>nonlinear<em> approximation architecture, where the impact of decisions to move resources from one part of the network to another is captured using a nonlinear function. This introduces unique complications that do not arise with more traditional linear architectures, but produces much better results.</em>

<a href="http://castle.princeton.edu/Papers/Topaloglu%20Powell-Distributed%20decision%20making%20structure%20for%20resource%20allocation.pdf" target="_blank" rel="noopener">(Click here to download paper)</a>

<strong>Shapiro, J. and W.B. Powell, “A Metastrategy for Dynamic Resource Management Problems based on Informational Decomposition,” Informs Journal on Computing, Vol. 18, No. 1, pp. 43-60 (2006). (c) Informs.</strong>
